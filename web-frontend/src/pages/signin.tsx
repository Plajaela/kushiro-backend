...
const Signin = () => {
	...
	return (
		<>
			...
			>
				<section className=" bg-white flex flex-grow m-16 rounded-2xl p-16 flex-col bg-opacity-50 align-middle justify-between gap-5">
					<div className="w-full flex flex-row align-middle justify-start">
						<BiSolidQuoteAltLeft size={60} color="white" />
					</div>
					<div className="flex flex-grow flex-row px-10 gap-20">
						...
						<div className="w-1/2 bg-white bg-opacity-45 rounded-2xl flex flex-col align-middle justify-between p-10">
					...
					<div className="w-full flex flex-row align-middle justify-end">
						<BiSolidQuoteAltRight size={60} color="white" />
					</div>
				</section>
			</main>
		</>
