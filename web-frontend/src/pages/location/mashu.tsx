		...
		<>
			...
			>
				...
				<div className="grid grid-cols-6 grid-rows-6 gap-5 h-[70rem]">
					...
					<div
						className="relative row-span-3 col-span-4"
						style={{
							gridRowStart: 4,
							gridColumnStart: 3,
						}}
						...
						return (
							...
							>
								...
								<div className="w-full flex flex-col align-middle gap-1">
									<h3 className="text-3xl">Lake Mashu</h3>
...
export async function getServerSideProps() {
	const response = await fetch(
		`${process.env.BACKEND_CONTAINER}/review/list/MASHU?limit=3`
	);
