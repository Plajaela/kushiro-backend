...
const Akan = ({ data }: { data: Data[] }) => {
	const router = useRouter();
	return (
		<>
			<Head>
				<title>Lake Akan</title>
			</Head>
			<main
				className={
					jakarta.className +
			...
			>
				...
				<div className="grid grid-cols-6 grid-rows-6 gap-5 h-[70rem]">
					<div className="relative row-span-3 col-span-2">
						<Image src={"/akan/2.png"} alt="akan-2" fill />
					</div>
					<div className="relative row-span-2 col-span-4">
						<Image src={"/akan/1.png"} alt="akan-1" fill />
					</div>
					<div
					...
					>
						<Image src={"/akan/5.png"} alt="akan-5" fill />
					</div>
					<div
					...
					>
						<Image src={"/akan/3.png"} alt="akan-3" fill />
					</div>
					<div
						className="relative row-span-4 col-span-2"
						style={{
					...
					>
						<Image src={"/akan/4.png"} alt="akan-4" fill />
					</div>
					<div
						...
						return (
							...
							>
								...
								<div className="w-full flex flex-col align-middle gap-1">
									<h3 className="text-3xl">Lake Akan</h3>
